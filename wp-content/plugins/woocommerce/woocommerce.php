	...
	public function init_taxonomy() {
		...
		register_post_type( "product",
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels' => array(
							'name' 					=> __( 'Program Setting', 'woocommerce' ),
							'singular_name' 		=> __( 'Program Setting', 'woocommerce' ),
							'menu_name'				=> _x( 'Program Setting', 'Admin menu name', 'woocommerce' ),
							'add_new' 				=> __( 'Add Program Setting', 'woocommerce' ),
							'add_new_item' 			=> __( 'Add New Program Setting', 'woocommerce' ),
							'edit' 					=> __( 'Edit', 'woocommerce' ),
							'edit_item' 			=> __( 'Edit Program Setting', 'woocommerce' ),
							'new_item' 				=> __( 'New Program Setting', 'woocommerce' ),
							'view' 					=> __( 'View Program Setting', 'woocommerce' ),
							'view_item' 			=> __( 'View Program Setting', 'woocommerce' ),
							'search_items' 			=> __( 'Search Program Setting', 'woocommerce' ),
							'not_found' 			=> __( 'No Program Setting found', 'woocommerce' ),
							'not_found_in_trash' 	=> __( 'No Program Setting found in trash', 'woocommerce' ),
							'parent' 				=> __( 'Parent Program Setting', 'woocommerce' )
						),
					'description' 			=> __( 'This is where you can add new Program Setting to your store.', 'woocommerce' ),
					'public' 				=> true,
					'show_ui' 				=> true,
