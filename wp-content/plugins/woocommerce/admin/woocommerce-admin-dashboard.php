...
global $hide_dashboard_widget;
	...
	if ( current_user_can( 'publish_shop_orders' ) &&  !$hide_dashboard_widget) {
	...
	if ( (current_user_can( 'view_woocommerce_reports' ) || current_user_can( 'publish_shop_orders' )  ) && !$hide_dashboard_widget) {
