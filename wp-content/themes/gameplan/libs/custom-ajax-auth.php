...
function ajax_auth_init(){	
	wp_register_style( 'ajax-auth-style', get_template_directory_uri() . '/css/jquery-ui.css' );
...
function ajax_register(){
    ...
    $user_register = wp_insert_user( $info );
 	if ( is_wp_error($user_register) ){	
	  ...
	  add_user_meta( $user_register, 'birthdate', $_POST['birthdate']);
	  add_user_meta( $user_register, 'gender', $_POST['gender']);
	  add_user_meta( $user_register, 'country', $_POST['country']);
	  add_user_meta( $user_register, 'phone', $_POST['phone']);
